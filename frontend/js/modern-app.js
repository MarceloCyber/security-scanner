...
async function loadAutomationData() {
    ...
    try {
        ...
        document.getElementById('automation-uptime').textContent = stats.average_uptime == null ? '—' : `${Number(stats.average_uptime).toFixed(1)}%`;
